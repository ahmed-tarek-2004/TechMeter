...
namespace TechMeter.Infrastructure.Migrations
{
    ...
    [Migration("20260628213956_AddingUserConnetionsAndGroupTables ")]
    partial class AddingUserConnetionsAndGroupTables
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TechMeter.Domain.Models.Auth.Groups", b =>
                {
            ...
            modelBuilder.Entity("TechMeter.Domain.Models.Auth.UserConnections", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("TechMeter.Domain.Models.LessonCommentLike", b =>
                {
                    b.Property<string>("UserId")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("TechMeter.Domain.Models.Notification", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("TechMeter.Domain.Models.UserFcmToken", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("GroupsUser", b =>
                {
                    b.HasOne("TechMeter.Domain.Models.Auth.Groups", null)
                        .WithMany()
            ...
            modelBuilder.Entity("TechMeter.Domain.Models.LessonCommentLike", b =>
                {
                    b.HasOne("TechMeter.Domain.Models.LessonComment", "LessonComment")
                        .WithMany("LessonCommentLikes")
                        .HasForeignKey("CommentId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("TechMeter.Domain.Models.Lessons", null)
                        .WithMany("lessonCommentsLike")
            ...
            modelBuilder.Entity("TechMeter.Domain.Models.Lessons", b =>
                {
                    ...
                    b.Navigation("lessonCommentsLike");
                });
