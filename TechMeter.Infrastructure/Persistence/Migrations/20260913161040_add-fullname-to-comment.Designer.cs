...
namespace TechMeter.Infrastructure.Migrations
{
    ...
    [Migration("20260913161040_add-fullname-to-comment")]
    partial class addfullnametocomment
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TechMeter.Domain.Models.Auth.UserMessages", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TechMeter.Domain.Models.LessonComment", b =>
                {
                    ...
                    b.HasOne("TechMeter.Domain.Models.LessonComment", "ParentComment")
                        .WithMany("Replies")
